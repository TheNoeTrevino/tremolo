      ...
      <Container maxWidth="lg">
        <Box sx={landingPageStyles.section}>
            ...
            <Box sx={landingPageStyles.iconTextSection}>
              ...
              <Box>
                ...
                <Typography variant="body1" sx={{ lineHeight: 1.8 }}>
                  ...
                  rooms. Wouldn't it be great to dive into these specific patterns
                  for preparation? Or practice simplified versions of difficult
                  rhythms to guide students along a more logical learning path?
                  What about applying notes over frequently-tested rhythms? Our
                  goal is to address all these needs.
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={landingPageStyles.iconTextSection}>
              ...
              <Box>
                ...
                <Typography variant="body1" sx={{ lineHeight: 1.8 }}>
                  ...
                  musicianship, Tremolo adapts to your needs. Set your parameters,
                  choose your difficulty, and watch your skills grow with
                  measurable progress.
                </Typography>
              </Box>
            </Box>
          ...
          >
            ...
            <Typography
              variant="body1"
              sx={{ fontSize: "1.1rem", lineHeight: 1.8, maxWidth: "800px", mx: "auto" }}
            >
              ...
              advanced musical concepts. Whether you're a 6th grader learning your
              first rhythms or a seasoned musician refining your craft, this
