        ...
        datasets: [
            {
                ...
                data: chartData.npm.map(point => ({ x: point.x.getTime(), y: point.y })),
            ...
            {
                label: "Accuracy %",
                data: chartData.accuracy.map(point => ({ x: point.x.getTime(), y: point.y })),
            ...
            {
                label: "Session Count",
                data: chartData.sessionCount.map(point => ({ x: point.x.getTime(), y: point.y })),
            ...
            },
            {
                ...
                data: chartData.totalQuestions.map(point => ({ x: point.x.getTime(), y: point.y })),
    ...
    const options: ChartOptions<"line"> = {
        ...
        scales: {
            x: {
                type: "time",
                time: {
                    unit: interval === "day" ? "day" : interval === "week" ? "week" : interval === "month" ? "month" : "year",
                    displayFormats: {
                        day: "MMM d",
                        week: "MMM d",
                        month: "MMM yyyy",
